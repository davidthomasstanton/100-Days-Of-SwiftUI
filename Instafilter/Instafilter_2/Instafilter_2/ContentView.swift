...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                PhotosPicker(selection: $selectedItem) {
                    if let processedImage {
                        ...
                        ContentUnavailableView("Photo Unavailable", systemImage: "photo.badge.plus", description: Text("Tap to uplaod image"))
                    }
                }
                .buttonStyle(.plain)
            ...
            .navigationTitle("Instafilter_2")
            .confirmationDialog("Set Filter", isPresented: $showingFilters) {
