...
class User: Codable {
    ...
    static let exampleUser = User(id: UUID(), isActive: true, name: "Paul Hudson", age: 43, company: "Two Straws Industries", email: "paul@hackingwithswift.com", address: "555, Taylor Swift Dr", about: "Paul writes about Swift and dog-related topics", registered: Date.now, tags: ["swiftUI", "dogs"], friends: [])
